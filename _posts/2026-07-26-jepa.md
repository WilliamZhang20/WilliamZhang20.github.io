...
toc:
  ...
  - name: Predicting puck stopping from a single strike
...
## Predicting puck stopping from a single strike
...
{% include figure.liquid path="assets/img/jepa/fetchslide.svg" class="img-fluid rounded z-depth-1" alt="FetchSlide controller predicts the puck resting point from a planned strike" zoomable=true %}
