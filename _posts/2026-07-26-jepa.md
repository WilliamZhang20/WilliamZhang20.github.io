...
FetchReach, latent MPC can optimize primitive action sequences directly. This
...
explicit for latent world-model planning <d-cite key="cheng2026sage"></d-cite>. In this project, I used two proposal models.
...
After canonicalization, the code expands each of the 13 normalized Fourier physical features as:
...
latent, then uses gated residual blocks to produce $K$ candidate outcomes:
...
Following the HWM idea of coupling temporal levels in a shared latent space <d-cite key="zhang2026hwm"></d-cite>, a macro-action encoder compresses a primitive chunk,
...
The protocol-aligned evaluation places these controllers across a broader task
set: AntMaze reached 72/54/31 on UMaze/Medium/Large, Adroit Door and Relocate
reached 101.46 and 85.04 normalized return, and Kitchen reached a 90.75
normalized score. Together, the results show a compact JEPA working as a
